...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Start(Animator=1;Rigidbody rb=2;)
    {        
    ...
    private void FixedUpdate()
    {
        ...
        float horizontal = 0; // 이 변수와
        float vertical = 0; // 이 변수를 사용해야 합니다.
